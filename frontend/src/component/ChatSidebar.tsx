...
const ChatSidebar = ({
    ...
    ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0 transition-transform duration-300 flex-col`}>
                    ...
                    showAllUsers ? (<div className="space-y-4 h-full">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-gray-800 border bordder-gray-700 text-white placeholder-gray-400"
                                value={searchQuery}
            ...
            <div className="p-4 border-t border-gray-700 space-y-2">
                <Link href={'/profile'} className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors">
                    ...
                    <span className="font-mediumtext-gray-300">Profile</span>
                </Link>
