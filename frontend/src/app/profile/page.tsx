                            ...
                            <label className="block text-sm font-semibold text-gray-300 mb-3">Display Name</label>
                            {
                                isEdit ? <form onSubmit={submitHandler} className="space-y-4">
                                    <div className="relative">
                                        ...
                                        px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400"/>
                                    ...
                                    <button onClick={editHandler} className="flex items-center gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-700
